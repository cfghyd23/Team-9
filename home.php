...
<?php include'ticker.php'; ?>
  ...
  <div ><a href="https://bit.ly/warriorsbot" target="_blank"><img style="width: 50px;
    float: right;
    top: 380px;
    position: relative;" src="https://png.pngtree.com/png-vector/20221018/ourmid/pngtree-whatsapp-mobile-software-icon-png-image_6315991.png" ></a></div>
    <div class="container">
...
<br>
        <h1 style="text-align:center;font-size:45px;">Welcome to Blood Connect Donor Management System</h1>
<br>
        <div class="row">
